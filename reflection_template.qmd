...
Another example of my revisions was on Lab 4 Question 6. The comments that I received on this part of the lab pertained to the creation of my plot. I revised my code to address these comments, and in my reflection, I wrote about what I learned from this, saying, **"Question 6: I had four comments on my submission. The first comment was in regard to changing the order of the facets. Initially, I had an order of infant, preschooler, and then toddler, instead of what was on the plot. This made less sense as it wasn't proceeding in terms of ages. I fixed this by using the function .fct to reorder the levels. From this, I learned exactly how forcats functions could be used to reorder the facets so that a plot makes more sense to the viewer. \

The second comment I got was in regards to changing the size of the texts in my plot. Initially, I changed the size of the x axis text in my plot, but not any of the other texts in the plot. I changed this in my code by using axis.text and other related functions. From this, I learned how important it was to keep the size consistent in my plot, so that I don't strain my viewer's eyes between sizes of texts. \

The third comment I had was on how to reorder the lines of the plot in the legend. I was able to do this by using the function fct_reorder2. From this, I learned how I can reorder the values within my legend and give it a signature look and order it however I want, as opposed to the default order it has. \

The fourth comment I had was on using the RColorBrewer Palette and theme_bw to match the color and theme of the plot. I was able to match the theme by using theme_bw, and changing the color of the lines by using a custom color palette using RColorBrewer. From this, I learned the different uses that a theme could have on the look of a plot, as using theme_bw made my plot more appealing to look at, as well as the capabilities of using a custom color palette to give my plots a unique look as opposed to a generalized look given by R default colors."**
...
![](images/Screenshot%202024-11-03%20at%208.27.30%20PM-01.png)
